...
<div class="flex justify-between items-center">
    <div>
        <h1 class="text-3xl font-bold text-blue-800">
            Device Monitoring: <span id="device-name">{{ $device->name }}</span>
        </h1>
        <p class="text-blue-600">
            Detailed analytics for device <span id="device-id">{{ $device->device_id }}</span>
        </p>

        <a href="{{ route('energy-analytics.exportPdf', ['id' => $device->id]) }}" class="inline-flex items-center px-3 py-4 mt-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
