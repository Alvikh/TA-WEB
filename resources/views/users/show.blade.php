        ...
        <div class="p-6">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-6 pb-6 border-b border-gray-200">
                ...
                <div class="relative">
                    ...
                    <img src="{{ asset($user->profile_photo_path) }}" alt="{{ $user->name }}" class="h-32 w-32 rounded-full object-cover border-4 border-white shadow-md">
                    @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div class="md:col-span-2 mt-6 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <a href="{{ route('users.export.detail', $user) }}" class="inline-flex items-center px-3 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
