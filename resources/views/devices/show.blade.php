            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div class="md:col-span-2 mt-6 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <a href="{{ route('devices.export.detail', $device) }}" class="inline-flex items-center px-3 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
