...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-indigo-600 to-purple-700">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-indigo-100">Update details for {{ $device->name }}</p>
                    </div>
            ...
            <!-- Form Content -->
            <form action="{{ route('devices.update', $device->id) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-5">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Update basic details about the IoT device.</p>
                    </div>

                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <!-- Owner Information (Read-only) -->
                        <div class="sm:col-span-2">
                            <label for="owner_display" class="block text-sm font-medium text-gray-700">Device Owner</label>
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="text" id="owner_display" value="{{ $device->owner ? $device->owner->name : 'Tidak ada pemilik' }}" readonly class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-gray-50 sm:text-sm cursor-not-allowed">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="building" id="building" value="{{ old('building', $device->building) }}" required class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150" placeholder="e.g., Lab RPL">
                                </div>
                                @error('building')
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name', $device->name) }}" required class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150" placeholder="e.g., Main Entrance monitoring">
                                </div>
                                @error('name')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="device_id" id="device_id" value="{{ old('device_id', $device->device_id) }}" required class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150" placeholder="Unique device identifier">
                                </div>
                                @error('device_id')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <select name="type" id="type" required class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm appearance-none bg-white bg-no-repeat transition duration-150">
                                        ...
                                        <option value="monitoring" {{ old('type', $device->type) == 'monitoring' ? 'selected' : '' }}>Monitoring</option>
                                        <option value="controlling" {{ old('type', $device->type) == 'controlling' ? 'selected' : '' }}>Controlling</option>
                                    </select>
                                </div>
                                @error('type')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="date" name="installation_date" id="installation_date" value="{{ old('installation_date', $device->installation_date ? $device->installation_date->format('Y-m-d') : '') }}" class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 transition duration-150">
                                </div>
