    ...
    <head>
        ...
        <title>Smart Power Management - Smart Energy Prediction</title>
        <!-- Tailwind CSS -->
    ...
    <section id="download" class="py-20 bg-blue-900 bg-opacity-30" data-aos="fade-up">
            <div class="container mx-auto px-4">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <p class="text-xl text-blue-200 mb-10">Monitor your energy consumption anytime, anywhere with the Smart Power Management mobile application.</p>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p>info@Smart Power Management.com</p>
                                            <p>support@Smart Power Management.com</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
